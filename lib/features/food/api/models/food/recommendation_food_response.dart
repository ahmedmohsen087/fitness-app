...
class RecommendationFoodResponse {
  ...
  RecommendationFoodResponse({this.categories});

  factory RecommendationFoodResponse.fromJson(Map<String, dynamic> json) =>
      _$RecommendationFoodResponseFromJson(json);
